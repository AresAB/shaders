...
int main(int argc, char *argv[])
{
    ...
    Shader light_shader("src/light_vert.vs", "src/light_frag.fs");
    ...
    ImVec4 cool_color = ImVec4(0.f, 0.f, 0.55f, 1.f);
    ImVec4 warm_color = ImVec4(0.3f, 0.3f, 0.f, 1.f);
    ImVec4 surface_mat = ImVec4(1.f, 1.f, 1.f, 1.f);
    ImVec4 light_pos = ImVec4(0.f, 1.f, 4.f, 1.f);
	...
	ImGui::SliderFloat4("Cool Color", (float*)&cool_color, 0, 1);
	ImGui::SliderFloat4("Warm Color", (float*)&warm_color, 0, 1);
	ImGui::SliderFloat4("Surface Material", (float*)&surface_mat, 0, 1);
	ImGui::SliderFloat4("Light Position", (float*)&light_pos, -5, 5);
	ImGui::SliderFloat4("Light Color", (float*)&light_color, 0, 1);
	ImGui::End();
	...
	ourShader.setVec3("uViewPos", -view_loc[3][0], -view_loc[3][1], -view_loc[3][2]);
        ourShader.setMat4("perspective", makePerspectiveMatrix(perspective_fov, (float)SCR_WIDTH / (float)SCR_HEIGHT, near_z, far_z)); 

	ourShader.setVec3("uCoolColor", cool_color.x, cool_color.y, cool_color.z);
	ourShader.setVec3("uWarmColor", warm_color.x, warm_color.y, warm_color.z);
	ourShader.setVec3("uSurfaceMat", surface_mat.x, surface_mat.y, surface_mat.z);
	ourShader.setVec3("uLightColor", light_color.x, light_color.y, light_color.z);
	ourShader.setVec3("uLightPos", light_pos.x, light_pos.y, light_pos.z);
    	...
    	glm::mat4 light_model = glm::translate(model, glm::vec3(light_pos.x, light_pos.y, light_pos.z));
    	light_model = glm::scale(light_model, glm::vec3(0.05f));
	light_shader.use();
        light_shader.setMat4("model", light_model);
        light_shader.setMat4("view", view_dir * view_loc);
        light_shader.setMat4("perspective", makePerspectiveMatrix(perspective_fov, (float)SCR_WIDTH / (float)SCR_HEIGHT, near_z, far_z)); 
	light_shader.setVec3("light_col", light_color.x, light_color.y, light_color.z);
        cube.render();
